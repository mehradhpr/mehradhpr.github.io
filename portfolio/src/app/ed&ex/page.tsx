...
const Experience = () => {
  return (
    <div className="w-full min-h-screen overflow-hidden flex flex-col items-center p-4">
      ...
      <section className="flex flex-col gap-5 min-[830px]:gap-16 w-full items-center justify-center min-[1400px]:grid min-[1400px]:grid-cols-2 min-[1400px]:max-w-[1400px]">
